	...
	<div class="container">
		<div class="row main">
			...
			<form:form
				...
				class="form-horizontal" modelAttribute="prodmodel"
						...
						<tbody>
							<c:forEach var="prodlist" items="${productList}">
								<tr>
									...
									<td><img
										src="<c:url value="/resources/${prodlist.productId}.jpg"/>"
										width="100px" height="80px" /></td>

									<td><input type="button"
										class="btn btn-info navbar-inverse" value="Delete"
										onclick="location.href = '<c:url value="deleteProduct${prodlist.productId}"/>';">
										<input type="button" class="btn btn-info navbar-inverse"
										value="Update"
										onclick="location.href = '<c:url value="updateProduct${prodlist.productId}"/>';">
									</td>
