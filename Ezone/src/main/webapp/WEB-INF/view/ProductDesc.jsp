				...
				<div class="preview col-md-6">
					...
					<div class="preview-pic tab-content">
						<div class="tab-pane active" id="pic-1">
							<img src="<c:url value="/resources/${prodmodel.productId}.jpg"/>"
					...
					<div class="action">
						<security:authorize access="hasRole('ROLE_USER')">
							<form action="${pageContext.request.contextPath}/user/addToCart"
								...
								<input type="hidden" value="${prodmodel.productName}"
									name="name" /> <label class="control-label col-sm-2">Quantity</label>
								<input type="number" class="form-control" name="quant" required />

								<br> <input class="btn btn-primary navbar-inverse"
									type="submit" value="Add to cart">
							</form>
						</security:authorize>
						<br> <a class="btn btn-primary navbar-inverse"
							href="${pageContext.request.contextPath}/productlist">Back</a>
