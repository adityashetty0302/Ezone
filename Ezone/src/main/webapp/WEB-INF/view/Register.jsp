			...
			<form:form action="AddUser" class="form-horizontal"
					...
					<div class="col-sm-5">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								type="password" class="form-control" name="password" id="paw"
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa fa-globe fa-lg" aria-hidden="true"></i></span> <input
					...
					<div class="col-sm-11">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								type="text" class="form-control" name="address" id="country"
