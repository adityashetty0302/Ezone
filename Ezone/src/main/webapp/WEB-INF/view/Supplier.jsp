...
<td>
			 <input type="button" class="btn btn-info navbar-inverse" value="Delete" onclick="location.href = '<c:url value="deleteSupplier${suplist.supId}"/>';"> /
			 <input type="button" class="btn btn-info navbar-inverse" value="Update" onclick="location.href = '<c:url value="updateSupplier${suplist.supId}"/>';">
		</td>
</tr>
</c:forEach>
</tbody>
