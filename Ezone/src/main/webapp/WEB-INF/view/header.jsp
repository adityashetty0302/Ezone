...
<body>
	...
	<div class="collapse navbar-collapse" id="bs-example-nav">
		<ul class="nav navbar-nav">
			...
			<li><a href="${pageContext.request.contextPath}/productlist">View
					Products</a></li>
			...
			<security:authorize access="hasRole('ROLE_ADMIN')">
				<li class="w3-dropdown-hover"><a class="w3-dropdown-toggle"
					data-toggle="dropdown" href="#">Admin Tools<span class="caret"></span></a>
					<div class="w3-dropdown-content w3-bar-block w3-card-4">
						<a href="${pageContext.request.contextPath}/admin/category"
							class="w3-bar-item w3">Category</a> <a
							href="${pageContext.request.contextPath}/admin/supplier"
							class="w3-bar-item w3">Supplier</a> <a
							href="${pageContext.request.contextPath}/admin/product"
							class="w3-bar-item w3">Product</a>
